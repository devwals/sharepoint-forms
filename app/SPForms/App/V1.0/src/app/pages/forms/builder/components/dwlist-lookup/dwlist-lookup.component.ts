...
@Component({
  selector: 'dwlist-lookup',
  templateUrl: './dwlist-lookup.component.html',
  styleUrls: ['./dwlist-lookup.component.scss']
})
export class DWListLookupComponent implements OnInit, IComponent {
  static type = "listlookup";
