...
export class DWManagedMetadataComponent implements OnInit, IComponent {
  static type = "managedmetadata";

  schema: any = {
    validation: ["required"],
    properties: ["id", "type", "label", "class", "displayLabel", "hiddenField", "readOnly", "disabled", "readOnly", "helpBlock", "tooltip", "placeholder"]
  };
